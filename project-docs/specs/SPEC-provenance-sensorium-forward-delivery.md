# Spec: Provenance Sensorium Forward Delivery Contract

## Objective

Bring Provenance Sensorium to the shared Project Telos public/developer delivery
floor while preserving local sensor and receipt behavior.

## Requirements

- [x] Keep README, USAGE, AGENTS, public-boundary docs, fixtures, tests, and CI
  aligned.
...
- [x] `python -m provenance_sensorium scan fixtures/sample_project` passes.
